...
function GoogleReviewCard({
  ...
  return (
    <article className="flex h-full w-[300px] shrink-0 flex-col rounded-2xl bg-sage p-5 shadow-luxury sm:w-[340px]">
    ...
    <section className="section-padding bg-cream">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="mb-4 text-xs font-bold uppercase tracking-luxury text-sage">
            Reviews
          </p>
          <h2 className="font-serif text-3xl font-light text-foreground sm:text-4xl lg:text-[2.75rem]">
